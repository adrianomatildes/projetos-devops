# ambientes/hml/route-table-association-priv/terragrunt.hcl

include { path = find_in_parent_folders() }

dependency "subnet_priv" {
  config_path = "../subnet-priv"
  mock_outputs = { subnet_id = "subnet-priv" }
...
inputs = {
  subnet_id      = dependency.subnet_priv.outputs.subnet_id
